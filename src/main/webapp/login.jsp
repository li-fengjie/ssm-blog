...
<body>
	...
	<form action="${pageContext.request.contextPath}/blogger/login"
	...
	<div style="text-align:center;padding-top: 30px">
		<div class="footer">
			All Copyright Reserved ©2020 我要大学答案-博客<a href="http://www.miitbeian.gov.cn" target="_blank">冀ICP备18026772号-1</a>
		</div>
	</div>
</body>
</html>