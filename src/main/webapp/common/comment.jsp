...
<script>
    ...
    function submitData() {
        ...
        var url = "${pageContext.request.contextPath}/comment/save";
        var params = {
            content: content,
            "id": "${blog.blogId}"
        };
...
<div id="container" style="position: relative;">
    <div id="wrapper" class="" data-version="">
        <div id="wf">
            <div id="wf-form" class="wf-form ">
                <div class="wf-content-wrapper">
                    <img class="wf-profile text-indent"
                         src="https://images.cnblogs.com/cnblogs_com/jxust-jiege666/1180300/o_1519900199.png" title="头像"
                         alt="头像">
                ...
                <div class="wf-function-wrapper">
                    ...
                    <button type="button" class="guest-write-btn wf-write-btn " id="guest-write-btn"
                            onclick="submitData()">
                        <span>发布</span>
                    </button>
                </div>
    ...
    <c:forEach items="${commentList}" var="comment">
        <div id="list" class="">
            <div class="reply-wrapper" data-own="0" data-secret="false" style="">
                <div class="reply-top">
                    <div class="writer" data-own="0" data-seq="26943578">
                        <ul class="writer-account">
                            <li class="writer-img" data-path="r_profile">
                                <img src="https://images.cnblogs.com/cnblogs_com/jxust-jiege666/1180300/o_1519900199.png"
                                     alt="头像" onerror="Livere.imgError.call(this)">
                            </li>
                ...
                <div class="reply-bottom">
                    ...
                    <div class="child-reply" style="margin-left:0px;"></div>
                </div>
            </div>
        </div>
    </c:forEach>
