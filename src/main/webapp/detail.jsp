...
<div id="mydiv" style="height:1000px;">
                        ...
                        <div id="posts" class="posts-expand">
                            <article class="post post-type-normal" itemscope="" itemtype="http://schema.org/Article"
                                ...
                                <link itemprop="mainEntityOfPage"
                                      href="http://www.ezlippi.com/blog/2018/02/the-missing-stacktrace.html">
    ...
    <span style="display:none" itemprop="logo" itemscope="" itemtype="http://schema.org/ImageObject">
      <a href="${pageContext.request.contextPath}/static/material/avatar.jpg" class="fancybox" rel="group"><img
              style="display:none;" itemprop="url image" alt="EZLippi-浮生志"
                ...
                <span itemprop="about" itemscope="" itemtype="http://schema.org/Thing">
                  <a href="${pageContext.request.contextPath }/blog/categories?id=${blog.blogType.id}&name=${blog.blogType.typeName}"
                    ...
                    <span itemprop="name">${blog.blogType.typeName }</span>
                                        ...
                                        <span id="/blog/2018/02/the-missing-stacktrace.html" class="leancloud_visitors"
                                              data-flag-title="JVM解惑:消失的异常堆栈">
               <span class="post-meta-divider">|</span>
               <span class="post-meta-item-icon">
                 <i class="fa fa-eye"></i>
               </span>
                                ...
                                <footer class="post-footer">
                                    <div>
                                        <ul class="post-copyright">
                                            ...
                                            <li class="post-copyright-link">
                                                <strong>本文链接：</strong>
                                                <a href="${pageContext.request.contextPath }/blog/articles?id=${blog.blogId }"
                                                   title=" ${blog.title }">${pageContext.request.contextPath }/blog/articles?id=${blog.blogId }</a>
                                            </li>
                                    ...
                                    <div class="post-nav">
                                        ...
                                        <div class="post-nav-next post-nav-item">
                                            <c:if test="${!empty preBlog }">
                                                <a href="${pageContext.request.contextPath }/blog/articles/${preBlog.id }"
                                                   rel="next" title="${preBlog.title }">
                                                    &lt;&nbsp;${preBlog.title }
                                                </a>
                                            </c:if>
                                        </div>
                                        ...
                                        <c:if test="${!empty nextBlog }">
                                            ...
                                            <div class="post-nav-prev post-nav-item">
                                                <a href="${pageContext.request.contextPath }/blog/articles/${nextBlog.id }"
                                                   rel="prev" title="${nextBlog.title }">
                                                        ${nextBlog.title } &nbsp;>
                                                </a>
                                            </div>
                                        </c:if>
                        ...
                        <section class="site-overview sidebar-panel sidebar-panel-active">
                            <div class="site-author motion-element" itemprop="author" itemscope=""
                                ...
                                <img class="site-author-image" itemprop="image"
                                     src="https://images.cnblogs.com/cnblogs_com/jxust-jiege666/1180300/o_1519900199.png"
                                     alt="EZLippi">
