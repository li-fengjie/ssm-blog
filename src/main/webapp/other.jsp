...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/other/hm.js"></script>
...
<div class="wrap css3" id="wrap">
    <div class="wrapper">
        ...
        <div class="star_wp scale_box show" id="star_wp"><span class="star_bg"></span> <span class="star_box"></span>
        </div>
        <canvas id="canvas" width="1424" height="965"></canvas>
        <div class="btns_wp scale_box">
            <a class="btn_download JS-btn-download" href="${pageContext.request.contextPath }/blog/showIndex">返回博客</a>
        </div>
        ...
        <div class="footer">
            <div class="foot">
                <audio autoplay="autoplay">
                    <source src="https://p2.music.126.net/NtXmSDF8kNJGKyJOK3D8GA==/6668538022554964.mp3"
                            type="audio/mpeg">
                </audio>
                <p>Copyright ©2019 - 2020 我要大学答案 </p></div>
        </div>
    </div>
</div>
<script src="${pageContext.request.contextPath}/static/other/hm.js(1)"></script>
<script src="${pageContext.request.contextPath}/static/other/vendors.js"></script>
