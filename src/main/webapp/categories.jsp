                                        ...
                                        <h2 class="post-title">
                                            <h2 class="post-title">
                                                <a class="post-title-link"
                                                   href="${pageContext.request.contextPath }/blog/articles?id=${categoryName.blogId}"
                                                   itemprop="url">
                                            ...
                                            <div class="post-meta">
                                                <time class="post-time" itemprop="dateCreated"
                                                      datetime="2015-05-19T00:00:00+08:00" content="2015-05-19">
                                                        ${categoryName.releaseDate }
                                                </time>
                                            </div>
                                    </header>
                                </article>
