                                ...
                                <div class="category-all">
                                    <ul class="category-list">
                                        ...
                                        <li class="category-list-item"><a class="category-list-link"
                                                                          href="${pageContext.request.contextPath }/blog/categories?id=${blogType.id}&name=${blogType.typeName}">${blogType.typeName}</a><span
                                                class="category-list-count">${listCount[t.index] }</span></li>
                                        </c:forEach>
                                </div>
                            </div>
                        </div>
