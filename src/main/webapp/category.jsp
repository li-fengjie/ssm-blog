	...
	<h2 class="post-title" itemprop="name headline">categories</h2>
      ...
      <div class="category-all-page">
        ...
        <div class="category-all">
          ...
          <c:forEach var="blogType" items="${blogTypeList }" varStatus="t">
          <li class="category-list-item"><a class="category-list-link" href="${pageContext.request.contextPath }/blog/categories?id=${blogType.id}&name=${blogType.typeName}">${blogType.typeName}</a><span class="category-list-count">${listCount[t.index] }</span></li>
          </c:forEach>
        </div>
      </div>
  </div>
